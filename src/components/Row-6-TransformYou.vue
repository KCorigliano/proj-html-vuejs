...
.row{
    ...
    .img-box{
        ...
        .bg-absolute-4{
            ...
            right: 260px;
            z-index: -1;
            background: url('../assets/images/maxcoach-shape-07.png') no-repeat;
        }
        ...
        .bg-absolute-5{
            ...
            left: -290px;
            z-index: -1;
            background: url('../assets/images/maxcoach-shape-01.png') no-repeat;
        }
